package fx.example.binding.properties.controller;
...
import fx.example.binding.properties.model.PersonalViewModel;
...
public class PersonViewController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		surnameTextField.focusedProperty().addListener((observable, oldVal, newVal) -> {
			if(newVal) {
				System.out.println("Jeste� w " + surnameTextField);
			} else {
				System.out.println("Wyszed�e� z " + surnameTextField);
			}
		});
